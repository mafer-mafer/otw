...
export const welcomeEmail = async (username, email) => {
  try {
    let data = await axios.post(`/api/mail/send`, {
      ...
      text: "Welcome to K-On The Way!",
      html: `<!DOCTYPE html>
<html>
  <head>
    <meta name="viewport" content="width=device-width" />
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <title>Welcome to K-On The Way!</title>
    <style>
                    ...
                    <tr>
                      ...
                      >
                        ...
                        <p
                          ...
                          "
                        >
                          You're on the road to never forgetting an order or
                          trade again!
                        </p>
                        <br />
                        <table
